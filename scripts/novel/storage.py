...
# Use environment variable for data directory, fallback to standalone-style path if not set
BASE_DATA_DIR  = os.environ.get("CAELESTIA_DATA_DIR", os.path.abspath(os.path.join(SCRIPT_DIR, "..", "..", "data")))
DATA_DIR       = os.path.join(BASE_DATA_DIR, "novel")
