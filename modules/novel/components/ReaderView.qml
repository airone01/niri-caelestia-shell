...
Item {
    ...
    Rectangle {
        ...
        Column {
            ...
            Text {
                text: "⚠"; font.pixelSize: 32; color: c.m3error; opacity: 0.85
                anchors.horizontalCenter: parent.horizontalCenter
            }
            Text {
    ...
    Flickable {
        ...
        Column {
            ...
            Item {
                ...
                Row {
                    ...
                    spacing: 5
                    Rectangle { width: 8;  height: 2; radius: 1; color: c.m3primary; opacity: 0.3 }
                    Rectangle { width: 32; height: 2; radius: 1; color: c.m3primary; opacity: 0.7 }
                    Rectangle { width: 8;  height: 2; radius: 1; color: c.m3primary; opacity: 0.3 }
                }
            }
        ...
        ScrollBar.vertical: ScrollBar {
            ...
            contentItem: Rectangle { implicitWidth: 2; color: c.m3primary; opacity: 0.25; radius: 1 }
        }
    }
            ...
            Item {
                ...
                Rectangle {
                    ...
                    color: nextNavArea.containsMouse && readerView._hasNext
                        ? Qt.rgba(c.m3primary.r, c.m3primary.g, c.m3primary.b, 0.45)
                        : Qt.rgba(c.m3primary.r, c.m3primary.g, c.m3primary.b, 0.22)
                    Behavior on color { ColorAnimation { duration: 120 } }
